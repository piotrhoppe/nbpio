...
@TemplateRegistration(folder = "Project/PlatformIO", position = Integer.MAX_VALUE, displayName = "#nbpio_displayName", description = "NbpioDescription.html", iconBase = "org/netbeans/module/platformio/project/nbpio.png")
